...
class NilaiReviewerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        foreach ($pendaftars as $pendaftar) {
            ...
            $statusnilaiReviewer = NilaiReviewer::where('id', $pendaftar->id)->pluck('status')->first(); // Retrieve the first status value
        ...
        return view('nilai-management.reviewer.index', compact('data', 'divisis', 'divisiId'));
    }
